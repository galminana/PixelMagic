...
namespace PixelMagic.Rotation
{
    public class ShamanEnhancement : CombatRoutine
    {
        public override string Name
        {
            get
            {
                return "Shaman Enhancement Rotation";
            }
        }
        ...
        {
            Log.Write("Welcome to Shaman Enhancement Rotation", Color.Green);
        }
        ...
        public override void Pulse()
        {
            ...
            {
                if (WoW.HasTarget && WoW.TargetIsEnemy && !WoW.IsSpellOnCooldown("Lava Lash") && WoW.IsSpellInRange("Lava Lash"))
                {
